<h1>
  ...
  <a href="[https://www.dio.me/](https://web.dio.me/track/decola-tech-avanade-net-developer)">
    ...
    <span>Desafio de projeto .NET com Testes Unitários em C#</span>
</h1>

Projeto desenvolvido para fins didáticos com o objetivo da implementação de testes unitários com os conhecimentos adquiridos no módulo de fundamentos, da trilha .NET da DIO.
